...
export class ExplanationOverlayComponent extends LitElement {
  ...
  static styles: CSSResultGroup = css`
    ...
    .overlay-content-wrapper {
      ...
      /* justify-content: center; /* Quitamos esto para que flex-grow funcione bien */
      width: 90%;
      max-width: 650px;
      max-height: 85dvh; /* Mantenemos la altura máxima del contenedor */
      ...
      /* overflow: hidden; */ /* Quitamos el overflow hidden del wrapper */
    }
    ...
    .explanation-text {
      /* ... estilos de fuente/color existentes ... */
      ...
      overflow-y: auto; /* Habilita el scroll VERTICAL INTERNO */
      /* --- Scrollbar styling --- */
  ...
  // (El resto de la lógica TypeScript permanece igual que en la versión anterior)
